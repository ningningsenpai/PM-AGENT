...
Help Codex produce Chinese Markdown documentation for PM-Agent that is consistent, clear, maintainable, and useful for solo + AI-assisted development. Documents should support design, implementation, review, and showcase. Avoid empty slogans; documentation must serve development.
