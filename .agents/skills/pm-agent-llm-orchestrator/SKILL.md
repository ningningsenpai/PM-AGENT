...
| RAG | Keep in Phase 6 according to `AGENTS.md`; do not implement a full RAG chain in the first version |
...
2. Later, upgrade complex reasoning, key decisions, and final polishing to Codex / GPT only after user confirmation.
