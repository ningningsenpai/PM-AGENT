...
Help Codex design PM-Agent as an intelligent project management Agent platform by clarifying users, boundaries, feature priorities, business flows, terminology, and acceptance criteria. The goal is to ensure backend, frontend, data modeling, and Agent design all use the same product language.
