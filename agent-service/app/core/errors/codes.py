...
class ErrorCode(Enum):
    ...
    LLM_TOOL_CALLING_UNSUPPORTED = (40001, "模型提供方不支持工具调用")
    TOOL_NOT_REGISTERED = (40002, "工具未注册")
    TOOL_ARGUMENT_INVALID = (40003, "工具参数不合法")
    TOOL_EXECUTION_FAILED = (40004, "工具执行失败")
    TOOL_EXECUTION_TIMEOUT = (40005, "工具执行超时")
    AGENT_TOOL_LOOP_LIMIT_EXCEEDED = (40006, "Agent 工具调用超过限制")
