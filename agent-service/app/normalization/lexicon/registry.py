...
from app.normalization.matching import AhoMatcher, CompiledLexicon
        ...
        *,
        ...
        with self._lock:
            ...
            if fingerprint is not None and not force_reload:
                cached = self._compiled_cache.get((tenant_id, normalized_project_id, fingerprint))
        ...
        *,
        ...
        with self._lock:
            ...
            for context_key in context_keys:
                ...
                self._compiled_cache.pop((context_key[0], context_key[1], fingerprint), None)
