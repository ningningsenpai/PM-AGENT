...
from app.normalization.lexicon.models import LexiconManifest, LexiconScope
from app.normalization.lexicon.provider import LexiconProvider

__all__ = ["DEFAULT_LEXICON_ROOT", "JsonLexiconProvider", "LexiconLoadError"]


DEFAULT_LEXICON_ROOT = Path(__file__).resolve().parents[3] / "resources" / "lexicons"
...
class JsonLexiconProvider(LexiconProvider):
    ...
    def _load_manifest(
        ...
        *,
        ...
        try:
            raw_data: dict[str, Any] = json.loads(resolved_path.read_text(encoding="utf-8"))
