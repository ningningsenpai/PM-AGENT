...
from app.normalization.matching import AhoMatcher, CompiledLexicon, LongestMatchResolver
...
class NormalizationPipeline:
    ...
    def run(self, text: str, compiled_lexicon: CompiledLexicon) -> NormalizationResult:
        ...
        stage_started_at = perf_counter()
        matches = self.synonym_mapper.map_matches(text, normalized_text, selected_candidates)
