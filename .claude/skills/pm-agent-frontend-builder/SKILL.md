...
Help Claude produce readable frontend plans with clear component boundaries and a mature visual result for PM-Agent. The default base is an admin system, but it should avoid becoming a dull table-only interface. It should reflect Linear-style simplicity, whitespace, hierarchy, and state clarity.
