...
Help Claude design a stable, extensible, low-rework data model for PM-Agent. The model should make business relationships clear, query paths explicit, and Agent traces reproducible, while avoiding over-generalization in the first version.
